...
class FastNodeWeiXin {
  constructor(appid, appsecret, apptoken, getAccessToken, getJsTicket) {
    this.appid = appid;
    ...
    this.getAccessToken = function () {
      if (!!getAccessToken) {
        ...
        return this.getAccessTokenInside();
      }
    };
